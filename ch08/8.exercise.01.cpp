...
// give the Token_stream constructor (§7.8.2) an istream& parameter so that
// when we figure out how to make our own istreams (e.g., attached to files),
// we can use the calculator for those. Hint: Don't try to copy an istream.
//
// COMMENTS
// 
// We take the calculator as implemented in 7.exercise.09.cpp.
...
try {
    ...
    cout << "Tiny calculator. Write help for ... help.\n";
    calculate();
    return 0;
}
catch (exception& e) {
