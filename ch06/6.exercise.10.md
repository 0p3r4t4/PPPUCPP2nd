...
developed a sensation of incompleness about some solutions. It starts with the
quadratic equations solvers and culminates with this one. I've spent too much
time planning and thinking about it to, in the end, realize how far I'm to be
ready to face such an apparently simple problem. But it's not, in fact, that
simple:

-  Assure that the user has entered and integer and nothing more is much more
   than read an int from std::cin. Input parsing is hell.
...
Of couse, these are aspects that, on chapter 6, could be considered as advanced
topics. But I can't ignore them. But I will force myself to since I'm stuck and
in the need to continue. Since I spy on Bjarne's solution to the exercise and
he doesn't seem to care about what I care, I will take that he pretend it to
seem simple and reserve for later the unpleasant surprise of the reality.
