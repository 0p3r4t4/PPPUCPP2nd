...
//  use srand().
//   - Also randint(10) cuold return a value of 10, so you must use randint(9) instead.
//  
//  TRAPPED!!!
...
//      solutions, each of the imply to not use randint():
//          - use classical srand() and rand() inherited from C
//          - do as randint(), in c++ 11 style,  but explicitly in our
//          code (I take this one, although obviously advanced).
//
...
// Pre-condition:
//  size could not be grater than 10, since each number from [0, 9] could be included
...
//  Each element of the generated vector must be unique.
{
    ...
    // randomizing and eah element has to be unique. I'm sure there's a 
    // better way to do it.
